...
`,Ne=d.div`
  ...
  margin-top: 8px;
  padding: 0 16px;
`,Be=()=>{const{findTag:t,updateTag:n,deleteTag:o}=k(),{id:i}=U(),r=t(parseInt(i)),c=a=>l(te,{children:[e(Ne,{children:e(R,{label:"\u6807\u7B7E\u540D",type:"text",placeholder:"\u6807\u7B7E\u540D",value:a.name,onChange:u=>{n(a.id,{name:u.target.value})}})}),l(T,{children:[e(f,{}),e(f,{}),e(f,{}),e(L,{onClick:()=>o(a.id),children:"\u5220\u9664\u6807\u7B7E"})]})]}),s=_();return l(v,{children:[l(Ee,{children:[e(m,{name:"left",onClick:()=>{s.goBack()}}),e("span",{children:"\u7F16\u8F91\u6807\u7B7E"}),e(m,{})]}),r?c(r):l(T,{children:[e(f,{}),e(f,{}),"tag \u4E0D\u5B58\u5728"]})]})},Se=d.div`
  color: #333;
  max-width: 568px;
  margin: 0 auto;
